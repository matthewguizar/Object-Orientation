...
//Code Here
const iPhone = new Phone(`iPhone`, `iPhone 7`, 200, `White`, 999.99)
const blackBerry = new Phone(`BlackBerry`, `Evolve X`, 100, `black`, 250.00)
const google = new Phone(`Google Pixel`, `Pixel 6`, 256, `Gray`, 599.00)
// console.log(iPhone)
/* 
